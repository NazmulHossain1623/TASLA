...
\033[1;91m░╚════╝░░╚════╝░╚═╝░░░░░╚═╝╚══════╝
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mNAZMUL \033[1;95m-_-_-_-_-_-_-_-_-»
\033[1;92mNote1: PAID TOOLS.ENTER TOOLS KEY  
\033[1;92mNote2: THIS TOOLS MADE BY NAZMUL HOSSAIN
\033[1;95m«--_-_-_-_-_-_-_-\033[1;91m  TASLA  \033[1;95m-_-_-_-_-_-_-_-_-»
 """
Correct key = "7hAb4J828jUvLoEbAkT67FHUgkU8"
Correct key = "7hAb4J828jUvLoEbAkT67FHUgkU8"

loop = 'true'
while (loop == 'true'):
    username = raw_input("\033[1;91m \x1b[1;91mACTIVE KEY \x1b[1;91m: \x1b[1;92m")
    if (username == CorrectUsername):
    	password = raw_input("\033[1;91m \x1b[1;91mAGAIN TYPE ACTIVE KEY \x1b[1;91m: \x1b[1;92m")
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev: Nazmul_Hossain
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;93mWrong key"
            os.system('xdg-open https://www.facebook.com/NazmulHossain16239')
    else:
        print "\033[1;94mWrong key"
        os.system('xdg-open https://www.facebook.com/NazmulHossain16239')
